...
class TestRandomExplainer:
    """Test suite for the Random Explainer."""

    @pytest.fixture
    def basic_model_data(self):
    ...
    def test_random_explainer_basic_api(self, basic_model_data):
    ...
    def test_call_args_storage(self, basic_model_data):
    ...
    def test_clustering_ndarray(self, basic_model_data):
    ...
    def test_clustering_callable(self, basic_model_data):
    ...
    def test_clustering_unsupported_error(self, basic_model_data):
